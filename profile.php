      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="assets/profile/<?php echo ($row['idno'].'.jpg'); ?>" alt="Profile" class="rounded-circle">
    ...
    <nav class="header-nav ms-auto">
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="assets/profile/<?php echo ($row['idno'].'.jpg'); ?>" alt="Profile" class="rounded-circle">
            <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo $row["idno"]; ?></span>
          </a><!-- End Profile Iamge Icon -->
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <p class="small new-roman">Attendance Management System is software developed for daily student attendance inschools, colleges and institutes..</p>

                  <h5 class="card-title">Profile Details</h5>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label ">Id No</div>
                    <div class="col-lg-9 col-md-8"><?php echo ($row['idno']);?></div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo ($row['branch']);?></div>
                  </div>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Year</div>
                    <div class="col-lg-9 col-md-8"><?php echo ($row['year']);?></div>
                  </div>
                  ...
                  <!--<form>
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="assets/profile/<?php echo ($row['idno'].'.jpg'); ?>" alt="Profile">
                        <div class="pt-2">
